// BuzzerAlarmSchedulerTest.java --- Tests BuzzAlarmScheduler
...
public class BuzzAlarmSchedulerTest {
    ...
    public void alarmScheduler_getCalendarFromTimeString_minuteMidnight() {
        Calendar today = Calendar.getInstance();
        Calendar fromTimeString = BuzzAlarmScheduler.getCalendarFromTimeString("00:00", today);
    ...
    // Test BuzzAlarmScheduler::getNextAlarmTime
    @Test
    public void alarmScheduler_getNextAlarmTime_duringDay() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("13:37", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "22:00", "06:00", 5);
    ...
    public void alarmScheduler_getNextAlarmTime_duringSleepEarlyMorning() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("04:08", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "22:00", "06:00", 5);
    ...
    public void alarmScheduler_getNextAlarmTime_duringSleepLateNight() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("23:09", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "22:00", "06:00", 5);
        assertEquals(nextAlarm.get(Calendar.MINUTE), 0);
        assertEquals(nextAlarm.get(Calendar.HOUR_OF_DAY), 6);
    ...
    @Test
    public void alarmScheduler_getNextAlarmTime_longBuzzTime_duringDay() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("12:19", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "22:00", "06:00", 120);
        assertEquals(nextAlarm.get(Calendar.MINUTE), 0);
    ...
    @Test
    public void alarmScheduler_getNextAlarmTime_weirdBuzzTime_duringDay() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("11:39", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "22:00", "06:00", 93);
    ...
    public void alarmScheduler_getNextAlarmTime_noSleep_duringDay() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("13:37", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "00:00", "00:00", 5);
        assertEquals(nextAlarm.get(Calendar.MINUTE), 40);
        assertEquals(nextAlarm.get(Calendar.HOUR_OF_DAY), 13);
        assertEquals(nextAlarm.get(Calendar.DAY_OF_YEAR), day.get(Calendar.DAY_OF_YEAR));
    }
    ...
    public void alarmScheduler_getNextAlarmTime_noSleep_atSleepBreak() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("13:37", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "13:37", "13:37", 5);
    ...
    public void alarmScheduler_getNextAlarmTime_sleepDuringDay_inMorning() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("03:37", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "09:00", "17:00", 5);
        assertEquals(nextAlarm.get(Calendar.MINUTE), 40);
    ...
    public void alarmScheduler_getNextAlarmTime_longSleep() {
        Calendar day = Calendar.getInstance();
        Calendar time = BuzzAlarmScheduler.getCalendarFromTimeString("13:37", day);
        Calendar nextAlarm = BuzzAlarmScheduler.getNextAlarmTime(time, "00:01", "00:00", 5);
        assertEquals(nextAlarm.get(Calendar.MINUTE), 0);
